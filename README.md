...
- **Menú principal:** Inicio, Acerca, Servicios, **Tecnología**, Contacto (traducidos por idioma).
- **Otras páginas** (sin enlace en menú): productos, proyectos, calidad, blog, café, ajedrez, términos, privacidad.
- **Acerca:** perfil software + datos, CV por idioma (PDF en GitHub), intereses alineados con el README de [@devrfc83](https://github.com/devrfc83/devrfc83), orden alfabético por locale.
- **Tecnología:** stack por capas con iconos y enlaces (`src/lib/techStack.ts`, `src/components/technology/TechStack.tsx`).
- **Productos / proyectos:** en stand-by (Lorem ipsum); no priorizar sin pedido.
