...
import { faHouse, faUser, faBriefcase, faMicrochip, faEnvelope } from '@fortawesome/free-solid-svg-icons'
...
const NAV_PAGES: { page: PageId; icon: IconDefinition; labelKey: string }[] = [
  ...
  { page: 'technology', icon: faMicrochip, labelKey: 'common.nav.technology' },
...
const Header = () => {
  ...
  const EnlaceMenu = ({ page, icon, labelKey }: (typeof NAV_PAGES)[number]) => (
    <Link
      ...
      className='nav-link-motion underline-motion gap-1.5 text-sm whitespace-nowrap px-2'
    >
  ...
  return (
    <header className='border-base-200 bg-base-100/80 sticky top-0 z-40 w-full border-b backdrop-blur-md'>
